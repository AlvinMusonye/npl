...
const sidebarConfig = {
  ...
  financier: [
    ...
    { id: 'communication', label: 'My Conversations', icon: Mail, path: '/financier/communication' },
  ...
  lender: [
    ...
    { id: 'communication', label: 'My Conversations', icon: Mail, path: '/lender/communication' },
