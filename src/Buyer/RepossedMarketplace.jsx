        ...
        <div className="p-6">
          ...
          <div className="flex items-center justify-center pt-4 border-t border-gray-100">
            <button 
              ...
              className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-gray-100 hover:bg-gray-200 text-gray-800 font-semibold rounded-lg shadow-sm transition-all">
        ...
        <main className="flex-1 p-4 sm:p-6 lg:p-8 lg:ml-80 lg:mr-0 mr-20 transition-all duration-300">
          <div className="p-0 lg:p-4 w-full min-h-[85vh]">
            <header className="pb-4 mb-8">
              <h1 className="text-4xl font-bold text-black">Repossessed Assets Marketplace</h1>
              <p className="mt-2 text-lg text-gray-600">Browse and find repossessed assets available for sale.</p>
            </header>
            ...
            {!loading && !error && (
              assets.length > 0 ? (
                ...
                <div className="text-center py-16 bg-gray-50 rounded-3xl border border-gray-200">
                  ...
                  <p className="text-gray-500 mt-2">There are no repossessed assets listed for sale at the moment.</p>
                </div>
              )
            )}
          </div>
