...
import { Store, Contact, ArrowRight, CheckCircle } from 'lucide-react';
...
// =========================================================================
// 3. MAIN BUYER DASHBOARD COMPONENT
// =========================================================================

export default function BuyerDashboard({ setRole }) {
              ...
              <>
                <header className="p-8 mb-12 bg-gray-50 rounded-3xl border border-gray-200">
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    <p className="text-lg text-gray-600">Account Status:</p>
                    <span className="px-3 py-1 bg-green-100 text-green-800 font-semibold rounded-full border border-green-200 flex items-center gap-1">
                      <CheckCircle className="w-4 h-4" /> {dashboardData.account_status}
                    </span>
                  </div>
                </header>
                <section className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <NavCard title="Repossessed Marketplace" description="Browse and find repossessed assets for sale." Icon={Store} onClick={() => navigate('/buyer/marketplace')} />
                  <NavCard title="My Conversations" description="View your conversations with sellers." Icon={Contact} onClick={() => navigate('/buyer/conversations')} />
                </section>
              </>
            )}
          </div>
