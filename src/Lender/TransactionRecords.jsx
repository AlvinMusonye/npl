                ...
                <main className="flex-1 p-4 sm:p-6 lg:p-8 lg:ml-80 lg:mr-0 mr-20 transition-all duration-300">
                    <div className="p-0 lg:p-4 w-full">
                        ...
                        <form onSubmit={handleSubmit} className="max-w-2xl mx-auto space-y-6">
                            ...
                            <InputField icon={User} label="Sender (Buyer's User ID)" name="sender" placeholder="Enter buyer's user UUID" value={formData.sender} onChange={handleChange} />
                            ...
                            <div className="space-y-2">
                                ...
                                <textarea
                                    name="description"
                                    rows="4"
                                    placeholder="e.g., Payment received from Charles Buyer for vehicle KDA 555Z."
