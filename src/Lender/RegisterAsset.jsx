...
import { 
    Car, Home, Maximize, Upload, DollarSign, Calendar, FileText, CheckCircle, ArrowRight, X, LogOut, MapPin
} from 'lucide-react';
    ...
    return (
      ...
      >
        <div className="relative flex flex-col items-center gap-4">
          ...
          <p className="text-gray-600 text-center">List your {type.label.toLowerCase()} for sale</p>
        </div>
      </button>
    );
};
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
        <div className="p-12 max-w-md mx-4 shadow-2xl animate-scale-in bg-white rounded-3xl border">
            <div className="text-center">
                ...
                <p className="text-gray-600 mb-8">Your asset has been submitted and is now available on the marketplace.</p>
                <button
                    onClick={onClose}
...
export default function RegisterAssetPage({ setRole }) {
                ...
                return (
                    <div className="space-y-8">
                        <div className="text-center mb-12">
                            <h2 className="text-4xl font-bold text-black mb-4">List a Repossessed Asset</h2>
                            <p className="text-xl text-gray-600">Choose the type of asset you want to list for sale.</p>
                        </div>
                ...
                return (
                    <GlassCard className="p-8 shadow-2xl bg-white">
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            ...
                            <InputField icon={DollarSign} label="Sale Price (KES)" type="number" placeholder="e.g., 1200000" value={formData.sale_price_kes} onChange={(e) => handleInputChange('sale_price_kes', e.target.value)} />
                            <InputField icon={DollarSign} label="Market Valuation (KES)" type="number" placeholder="e.g., 1500000" value={formData.market_valuation_kes} onChange={(e) => handleInputChange('market_valuation_kes', e.target.value)} />
    ...
    return (
        <div className="min-h-screen bg-white">
            {showSuccess && <SuccessModal onClose={() => navigate('/lender/assets')} />}
