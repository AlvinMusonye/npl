    ...
    return (
      ...
      >
        ...
        <div className="relative flex flex-col items-center gap-4">
          ...
          <p className="text-[#4a6850] text-center">List your {type.label.toLowerCase()} for sale</p>
        </div>
      </button>
    );
};
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
        <GlassCard className="p-12 max-w-md mx-4 shadow-2xl animate-scale-in">
            <div className="text-center">
                ...
                <p className="text-[#4a6850] mb-8">Your asset has been submitted and is now available on the marketplace.</p>
                <button
                    onClick={onClose}
                ...
                return (
                    <div className="space-y-8">
                        <div className="text-center mb-8">
                            <h2 className="text-4xl font-bold text-[#1a3d2e] mb-4">List a Repossessed Asset</h2>
                            <p className="text-xl text-[#4a6850]">Choose the type of asset you want to list for sale.</p>
                        </div>
